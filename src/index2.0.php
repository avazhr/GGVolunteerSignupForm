...
<section style="padding: 16px;">
    <form method="POST" action="volunteer.php">
        ...
        <label class="checkbox-container">General Sports Volunteer
            <input type="radio" name="medical-uncheckbox" id="medical-uncheckbox" onclick="medicalUncheck()">
            <span class="checkmark"></span>
        </label>
        <label class="checkbox-container">Medical Volunteer
            <input type="radio" name="medical-checkbox" id="medical-checkbox" onclick="medicalCheck()">
            <span class="checkmark"></span>
        </label>
